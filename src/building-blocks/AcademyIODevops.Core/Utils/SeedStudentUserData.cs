namespace AcademyIODevops.Core.Utils
{
    public static class SeedStudentUserData
    {
        ...
        {
            new(AdminUserId, "Admin", "AcademyIODevops", "admin@academyio.com", "Teste@123", new DateTime(1990, 5, 5), true),
            new(User1Id, "Student1", "AcademyIODevops", "aluno1@academyio.com", "Teste@123",new DateTime(2000, 5, 5), false),
            new(User2Id, "Student2", "AcademyIODevops", "aluno2@academyio.com", "Teste@123",new DateTime(2000, 5, 5), false)
        };
    }
